...
const MedicationRegimensController = require("../controllers/medication-regimens.controller");
const SymptomEntryController = require("../controllers/symptom-entry.controller");
const MedicationSafetyController = require("../controllers/medication-safety.controller");
const ProfileExportController = require("../controllers/profile-export.controller");
...
// GET /api/v1/patient-profiles/{profileId}/medication-warnings
router.get(
  "/:profileId/medication-warnings",
  isAuth,
  MedicationSafetyController.getMedicationWarnings,
);
...
//8. PDF
router.post(
  "/:profileId/export-pdf",
  isAuth,
  ProfileExportController.exportPatientProfilePdf,
);
